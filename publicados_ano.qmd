---
title: "Ocurrencias Publicadas en GBIF por Año" # Sin espacios al inicio
format: 
  html: default # Indentado bajo 'format:'
execute:
  echo: false
---
...
published_by_year_url <- "https://analytics-files.gbif.org/country/EC/publishedBy/csv/occ.csv"
...
fig_published <- plot_ly() %>%
  ...
  layout(
    ...
    yaxis2 = list(overlaying = "y", side = "right", type = "log", title = list(text = "Total Acumulado Publicado (log)"), rangemode = "nonnegative"),
    margin = list(r = 80),
